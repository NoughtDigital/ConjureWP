...
if ( ! class_exists( 'Conjure_Freemius' ) ) :
	...
	class Conjure_Freemius {
		...
		public static function has_free_access() {
			...
			// When Freemius SDK is not loaded (e.g. free build or test env), grant full access.
		...
		public static function can_use_advanced_imports() {
			// When Freemius SDK is not loaded (e.g. free build or test env), allow advanced imports.
			if ( ! function_exists( 'con_fs' ) ) {
				return true;
			}
