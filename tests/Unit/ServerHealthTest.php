...
test('server health class exists and can be loaded', function () {
    $healthFile = conjurewp_test_get_plugin_path('includes/class-conjure-server-health.php');
...
test('server health can be instantiated', function () {
    require_once conjurewp_test_get_plugin_path('includes/class-conjure-server-health.php');
