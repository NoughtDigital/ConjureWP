...
test('importer logger class file contains proper class definition', function () {
    $loggerFile = conjurewp_test_get_plugin_path('includes/class-conjure-wp-importer-logger.php');
...
test('wxr import info class file contains proper class definition', function () {
    $infoFile = conjurewp_test_get_plugin_path('includes/class-conjure-wxr-import-info.php');
