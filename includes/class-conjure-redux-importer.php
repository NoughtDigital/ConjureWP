<?php
/**
 * Redux Importer Class
 *
 * This file contains the Redux importer functionality.
 *
 * @package Conjure WP
 */
	...
	public static function import( $import_data ) {
		...
		foreach ( $import_data as $redux_item ) {
			...
			if ( isset( $redux_framework->args['opt_name'] ) ) {
				...
				Conjure_Logger::get_instance()->debug( __( 'The Redux Framework data was imported', '@@textdomain' ), $redux_item );
			}
		}
