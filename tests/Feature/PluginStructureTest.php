...
test('all include classes exist', function () {
    $includeClasses = [
        ...
        'class-conjure-acf-json-importer.php',
        'class-conjure-gravity-forms-importer.php',
        'class-conjure-import-archive-helper.php',
        'class-conjure-connector-importers.php',
        'class-conjure-connector-upload-registry.php',
